package com.xing.library.helper.binds
...
import com.xing.library.view.base.Presenter
import com.xing.library.viewmodel.PagedViewModel
...
fun bindOnRefresh(v: SmartRefreshLayout, presenter: Presenter) {
